...
<body class="home" style="background-image: url('photos/top5.jpg'); background-size:100% 100%; background-repeat: no-repeat; ">
	<div id="wrapper">
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="form-group col-sm-6 col-xs-12">
								...
								<input type="text" class="form-control" name="qty" placeholder="Quantity" onchange="quantity(this.value)" required="" autocomplete="off"><br>
							</div>
...
if(isset($_POST['submit']))
    {
        ...
        if(!empty($insertValuesSQL)){
            $insertValuesSQL = trim($insertValuesSQL,',');
             ...
             $insert = mysqli_query($con,"INSERT INTO `tbl_gown`(`g_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `SL`, `SW`, `chest`, `waist`, `hip`, `bodice`, `SKlength`, `length`, `sweep`, `shoulder`, `comment`, `image`, `uid`,`materialprice`,`size`) VALUES ('','$Mtype','$Qty','$Bookdate','$Deliverydate','$colour','$slength','$swidth','$chest','$waist','$Hip','$bodice','$sklength','$length','$sweep','$shoulder','$cmt','$insertValuesSQL','$user','$mprice','$size')") or die(mysqli_error($con));
