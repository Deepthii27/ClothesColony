...
if(isset($_POST['submit']))
    {
        ...
        if(!empty($insertValuesSQL)){
            ...
            $insert = mysqli_query($con,"INSERT INTO `tbl_gshirt`(`gs_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `pocket`, `SL`, `SW`, `chest`, `waist`, `hip`, `shoulder`, `length`, `comment`, `image`, `uid`,`materialprice`,`size`) VALUES  ('','$Mtype','$Qty','$Bookdate','$Deliverydate','$colour','$pocket','$slength','$swidth','$chest','$waist','$hips','$shoulder','$length','$cmt','$insertValuesSQL','$user','$mprice','$size')") or die(mysqli_error($con));
