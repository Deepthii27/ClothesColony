...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2023 at 12:00 PM
...
INSERT INTO `tbl_blouse` (`b_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `SL`, `AB`, `ABOB`, `SB`, `FND`, `AOC`, `AA`, `shoulder`, `NtoS`, `BL`, `BND`, `comment`, `image`, `uid`, `status`, `materialprice`, `design_id`) VALUES
...
INSERT INTO `tbl_bshirt` (`bs_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `pocket`, `SL`, `SW`, `chest`, `waist`, `hip`, `shoulder`, `length`, `comment`, `image`, `uid`, `status`, `materialprice`) VALUES
...
INSERT INTO `tbl_gshirt` (`gs_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `pocket`, `SL`, `SW`, `chest`, `waist`, `hip`, `shoulder`, `length`, `comment`, `image`, `uid`, `status`, `materialprice`) VALUES
...
INSERT INTO `tbl_pant` (`p_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `height`, `waist`, `Thigh`, `bottom`, `kneelength`, `hip`, `comment`, `image`, `uid`, `status`, `materialprice`) VALUES
...
--
ALTER TABLE `tbl_gshirt`
  MODIFY `gs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_order_details`
  MODIFY `odid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
